  ...
  void setup() {
     ...
     *ANSWER : height/rows and width/cols
  ...
  void draw() {
     ...
     *Why do we do this? The simulation will go by too quickly if you call tick everytime draw is called. Simulation just takes longer and
